    ...
    <div class="auth-page">
      <div class="auth-card">
        ...
        <div class="social-buttons">
          <a class="social-btn social-btn--google" [href]="googleLoginUrl">
          ...
          <a class="social-btn social-btn--facebook" [href]="facebookLoginUrl">
            <svg class="social-btn__icon" viewBox="0 0 24 24" width="20" height="20">
...
export class LoginComponent implements OnInit {
  ...
  // URLs backend OAuth2 — Spring Security gère le redirect vers Google/Facebook
